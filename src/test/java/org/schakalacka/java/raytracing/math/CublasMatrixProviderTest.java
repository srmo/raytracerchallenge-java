...
class CublasMatrixProviderTest {

    private final CublasMatrixProvider provider = new CublasMatrixProvider();

    @Test
    void identity2() {
        CublasMatrix m = provider.get(2, true);
    ...
    @Test
    void identity3() {
        CublasMatrix m = provider.get(3, true);
    ...
    @Test
    void identity4() {
        CublasMatrix m = provider.get(4, true);
    ...
    void invert4() {
        ...
        var expectedInverse = provider.get(new double[][]{
                {0.21804511278195488f, 0.45112781954887216f, 0.24060150375939848f, -0.045112781954887216f},
                {-0.8082706766917294f, -1.4567669172932332f, -0.44360902255639095f, 0.5206766917293233f},
                {-0.07894736842105263f, -0.2236842105263158f, -0.05263157894736842f, 0.19736842105263158f},
                {-0.5225563909774437f, -0.8139097744360902f, -0.3007518796992481f, 0.30639097744360905f}
        });
